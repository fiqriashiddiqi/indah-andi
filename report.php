                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php
                                            ...
                                            // echo $jumlah;
                                        ?>
                                        <h4 class="mt-0 header-title">Jumlah orang yang akan hadir : <?php echo $jumlah;?> orang</h4>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                tabel = $('#tb-report').dataTable({
                    ...
                    "ajax":
                    {
                        "url": "https://riska-alwy.digital-invitation.com/view.php", // URL file untuk proses select datanya
                        "type": "POST"
                    },
                    // "deferRender": true,
